...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/v1/products/**").hasRole(INVENTORY_CLERK.name())
                .antMatchers(GET,"/api/v1/products/**").hasAuthority(INVENTORY_CLERK_READ.name())
                .antMatchers(POST,"/api/v1/products/**").hasAuthority(INVENTORY_CLERK_CREATE.name())
                .antMatchers(PUT,"/api/v1/products/**").hasAuthority(INVENTORY_CLERK_UPDATE.name())

                .antMatchers("/api/v1/category/**").hasAnyRole(ADMIN.name(), INVENTORY_CLERK.name())
                .antMatchers(GET,"/api/v1/category/**").hasAnyAuthority(ADMIN_READ.name(), INVENTORY_CLERK_READ.name())
